<template>
    <div class="rating_page">
        <head-top go-back="true" head-title='我的优惠'></head-top>
        <section v-if="!showLoading">
            <section class="category_title">
                <span :class="{choosed: categoryType === 1}" @click="categoryType = 1">红包</span>
                <span :class="{choosed: categoryType === 2}" @click="categoryType = 2">代金券</span>
            </section>
        </section>
            ...
            <section v-if="categoryType===1">
                <section class="hongbao_container">
                    ...
                    <ul class="hongbao_list_ul">
                        <li class="hongbao_list_li" v-for="item in hongbaoList" :key="Math.random()">
...
<script>
    ...
    import { getHongbaoNum } from '../../service/getDate'
