<template>
    <div class="confirmOrderContainer">
        <section v-if="!showLoading">
            <headTop go-back="true" head-title="确认订单" signin-up="confirmOrder"></headTop>
            <router-link :to="{path: '/confirmOrder/chooseAddress', query: {id: checkoutData.cart.id, sig: checkoutData.sig}}" class="address_container">
                <div class="address_empty_left">
                    ...
                    <div v-if="!choosedAddress" class="add_address">请添加一个收获地址</div>
            ...
            <transition name="slid_up">
                <div v-if="showPayWay" class="choose_type_Container">
                    <header>支付方式</header>
                    <ul>
                        <li v-for="(item, index) in checkoutData.payments" :key="index" :class="{choose: payWayId == item.id}">
        ...
        <alert-tip v-show="showAlert" :alert-text="alertText" @closeTip="showAlert=false"></alert-tip>
...
<script>
    ...
    import { checkout, getAddressList, placeOrders } from '../../service/getDate'
