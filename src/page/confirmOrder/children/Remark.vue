    ...
    <div class="rating_page">
        <section v-if="!showLoading">
            ...
            <section class="quick_remark" v-if="remarkList.remarks.length">
                ...
                <ul class="remark_arr_list_ul">
                    <li class="remark_arr_list_li" v-for="(item,index) in remarkList.remarks" :key="index">
                        <span :class="{first: remarkIndex == 0, last: remarkIndex == item.length - 1, choosed: remarkTextCurr && remarkTextCurr[index]&&(remarkTextCurr[index][0] == remarkIndex)}"
            ...
            <section class="input_remark quick_remark">
                ...
                <textarea class="input_text" v-model="inputTextCurr" placeholder="请输入备注内容(可不填)"></textarea>
            </section>
...
<script>
    ...
    import { getRemark } from '../../../service/getDate'
    ...
    export default {
        ...
        created() {
            ...
            this.remarkTextCurr = this.remarkText;
            this.inputTextCurr = this.inputText;
        },
        computed: {
            ...mapState([
        ...
        methods: {
            ...
            chooseRemark(index, remarkIndex, text){
                this.remarkTextCurr[index] = [remarkIndex, text];

                this.remarkTextCurr = Object.assign({}, this.remarkTextCurr);
            },
            //确认选择
            confirmRemark(){
                this.CONFIRM_REMARK({remarkText: this.remarkTextCurr, inputText: this.inputTextCurr});
                this.$router.go(-1);
            }
        },
    }
