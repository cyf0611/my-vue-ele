<template>
    <div class="order_page">
        ...
        <ul class="order_list_ul" v-load-more="loaderMore">
            <li v-for="(item, index) in orderList" :key="index" class="order_list_li">
        ...
        <alertTip :alert-text="alertText" v-if="showAlert" @closeTip="showAlert=false"></alertTip>
        <footGuide></footGuide>
    </div>
</template>
...
<script>
    ...
    import { getOrderList } from '../../service/getDate'
