        ...
        <section class="adddetail">
            <form action="" @submit.prevent>
                ...
                <section class="addbutton">
                    <button :class="{butopacity:butpart}" @click.prevent="submitThing" :disabled="!butpart">新增地址</button>
                </section>
            </form>
        </section>
...
<script>
    ...
    import { postAddAddress } from '../../../../../service/getDate'
    ...
    export default {
        ...
        methods: {
            ...
            bindThing() {
                if(this.message && this.mesthree && this.telenum && !this.verifyfour){
                    this.butpart=true;
                }else{
                    this.butpart=false;
                }
