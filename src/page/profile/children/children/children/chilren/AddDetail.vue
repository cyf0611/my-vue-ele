    ...
    <div class="rating_page">
        ...
        <section>
            <div class="add-detail">
                <input type="text" placeholder="请输入小区/写字楼/学校等" v-model="inputAdress" @keyup.enter="inputThing">
...
<script>
    ...
    import { searchNearby } from '../../../../../../service/getDate'
    ...
    export default {
        ...
        created() {
            this.inputAdress = this.addAddress || this.inputAdress
        },
        computed: {
            ...mapState([
                'addAddress'
