                ...
                <section class="description_header">
                    <router-link to="/shop/shopDetail" class="description_top">
                        ...
                        <section class="description_right">
                            ...
                            <p class="description_text">商家配送 / {{shopDetailData.order_lead_name}}分钟送达／配送费¥{{shopDetailData.float_delivery_fee}}</p>
                            ...
                            <ul>
                                <li v-for="(item, index) in menuList" :key="index">
                                    <header class="menu_detail_header">
                                        ...
                                        <p class="description_tip" v-if="TitleDetailIndex===index">
                                            <span>{{item.name}}</span>
                                            {{item.description}}
                                        </p>
                                    </header>
                                    <section v-for="(food, foodIndex) in item.foods" :key="foodIndex" class="menu_detail_list">
                                        <router-link :to="{path: 'shop/foodDetail', query: {image_path: food.image_path, description: food.description, month_sales: food.month_sales, name: food.name, rating: food.rating, rating_count: food.rating_count, satisfy_rate: food.satisfy_rate, food, shopId}}" class="menu_detail_link">
                                            ...
                                            <section class="menu_food_description">
                                                <h3 class="food_description_head">
                                                    ...
                                                    <ul v-if="food.attributes.length" class="attributes_ul">
                                                        <li v-for="(attribute, attributeIndex) in food.attributes" :key="attributeIndex" :style="{color: '#' + attribute.icon_color,borderColor:'#' +attribute.icon_color}" :class="{attribute_new: attribute.icon_name == '新'}">
